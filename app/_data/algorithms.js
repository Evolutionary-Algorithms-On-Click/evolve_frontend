...
export const algorithmData = [
    {
        name: "eaSimple",
        description:
            "The simplest evolutionary algorithm that uses a generational model.",
        parameters: {
            ...
            halloffame:
                "A HallOfFame object that contains the best individuals.",
    ...
    },
    {
        ...
        description:
            "An evolutionary algorithm that uses a generate-update model.",
        parameters: {
            toolbox: "A Toolbox that contains the evolution operators.",
            mu: "The number of individuals to select for the next generation.",
            lambda_: "The number of children to produce at each generation.",
