    ...
    return (
        <div className="w-full max-w-2xl mx-auto bg-white rounded-xl shadow-md p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                    <div className="font-semibold text-lg text-gray-900">RBF</div>
                ...
                >
                    <div className="font-semibold text-lg text-gray-900">Matérn (ν=2.5)</div>
                    <div className="text-sm text-gray-700 mt-1">
                ...
                >
                    <div className="font-semibold text-lg text-gray-900">Matérn (ν=1.5)</div>
                    <div className="text-sm text-gray-700 mt-1">
                ...
                >
                    <div className="font-semibold text-lg text-gray-900">Rational Quadratic</div>
                    <div className="text-sm text-gray-700 mt-1">
                ...
                >
                    <div className="font-semibold text-lg text-gray-900">Exp-Sine-Squared</div>
                    <div className="text-sm text-gray-700 mt-1">
                ...
                >
                    <div className="font-semibold text-lg text-gray-900">Dot Product</div>
                    <div className="text-sm text-gray-700 mt-1">
                ...
                >
                    <div className="font-semibold text-lg text-gray-900">White</div>
                    <div className="text-sm text-gray-700 mt-1">
                ...
                >
                    <div className="font-semibold text-lg text-gray-900">Constant</div>
                    <div className="text-sm text-gray-700 mt-1">
