...
const CreateNewAction = ({ onCreateNew }) => {
    return (
        <div className="h-full flex items-center justify-center p-12">
            <button
                onClick={onCreateNew}
                className="group flex flex-col items-center gap-6 p-12 rounded-2xl border-2 border-dashed border-gray-300 hover:border-blue-400 hover:bg-blue-50 transition-all duration-200"
            >
